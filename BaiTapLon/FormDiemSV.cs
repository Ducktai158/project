...
namespace BaiTapLon
{
    ...
    ORDER BY sv.MaSV, hp.MaHP;";
        ...
        {
            // Tên datagridview của bạn, giả sử là dgvDiem
            dgvDiemSinhVien.ColumnHeadersDefaultCellStyle.BackColor = Color.Navy;
            dgvDiemSinhVien.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            dgvDiemSinhVien.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10, FontStyle.Bold);
            dgvDiemSinhVien.EnableHeadersVisualStyles = false;

            dgvDiemSinhVien.DefaultCellStyle.Font = new Font("Segoe UI", 10);
            dgvDiemSinhVien.DefaultCellStyle.ForeColor = Color.Black;
            dgvDiemSinhVien.DefaultCellStyle.BackColor = Color.White;
            dgvDiemSinhVien.DefaultCellStyle.SelectionBackColor = Color.LightBlue;
            dgvDiemSinhVien.DefaultCellStyle.SelectionForeColor = Color.Black;

            dgvDiemSinhVien.GridColor = Color.LightGray;
            dgvDiemSinhVien.BackgroundColor = Color.WhiteSmoke;
            dgvDiemSinhVien.BorderStyle = BorderStyle.Fixed3D;

            dgvDiemSinhVien.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgvDiemSinhVien.RowTemplate.Height = 30;
            dgvDiemSinhVien.AllowUserToAddRows = false;
            dgvDiemSinhVien.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvDiemSinhVien.MultiSelect = false;

            dgvDiemSinhVien.ReadOnly = true;
        }
