...

        {
            ...
            using (SqlConnection conn = new SqlConnection(constr))
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    dtHP.Load(reader);
                    cbMaLop.DataSource = dtHP;
                    cbMaLop.DisplayMember = cbMaLop.ValueMember = "MaLop";     // Giá trị là Mã HP
                }
            }
        }
...
                             VALUES (@MaSV, @HoTen, @NgSinh, @GT, @MaLop, @TrangThai, @NamNhapHoc, @NamRaTruong)";
...

                    {
                        ...
                        cmd.Parameters.AddWithValue("@NamNhapHoc", cbNamNH.Text);

                        cmd.Parameters.AddWithValue("@NamRaTruong", cbNamRaTruong.Text);
